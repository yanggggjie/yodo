...
import { RESPONSE_SPLIT_BYTES } from "../utils/constants.ts";
import { writeJsonAtomic, exists } from "../utils/fs.ts";
import type {
  RawEvent,
  RawRequest,
  DomTimelineItem,
...
import { processDomTimeline, simpleDomTimeline } from "./dom.ts";
...
export async function writeArtifacts(
  ...
  items.push(...simpleDomTimeline(domTimeline));
